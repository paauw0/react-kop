...
var AutoComplete = function (props) {
    ...
    var generateDropdown = function () {
        return (React.createElement(Transition, { in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExited: function () { setSuggestions([]); } },
            React.createElement("ul", { className: "kop-suggestion-list" },
                ...
                suggestions.map(function (item, index) {
                    ...
                    return (React.createElement("li", { key: index, className: classes, onClick: function () { handleSelect(item); } }, renderTemplate(item)));
                }))));
    };
    return (React.createElement("div", { className: "kop-auto-complete", ref: componentRef },
