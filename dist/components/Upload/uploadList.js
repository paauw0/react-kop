...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "kop-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "kop-upload-list-item", key: item.uid },
