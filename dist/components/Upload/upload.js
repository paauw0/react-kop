...
var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "kop-upload-component" },
        React.createElement("div", { className: "kop-upload-input", style: { display: 'inline-block' }, onClick: handleClick },
            drag
                ?
                    React.createElement(Dragger, { onFile: function (files) { uploadFiles(files); } }, children)
                : children,
            React.createElement("input", { className: "kop-file-input", style: { display: 'none' }, type: "file", ref: fileInput, onChange: handleFileChange, accept: accept, multiple: multiple })),
